...
```
	...
	app.get('/login', function (req, res) {
	    ...
	    console.log("/lzhaoyim========port login get = ", req.params);
	    console.log("/lzhaoyim========port login req.query = ", req.query.port);
	...
	app.post('/login', function (req, res) {
	    ...
	    console.log("zhaoyim========port", req.body.port);
	    console.log("zhaoyim========user", user);
	    console.log("zhaoyim========pass", pass);
	    console.log("/login POST req.session.id=", req.session.id);
	    console.log("zhaoyim========userDatabase", userDatabase.hasOwnProperty(user));
	    console.log("zhaoyim========userDatabase", userDatabase[user] == pass);
	    if (userDatabase.hasOwnProperty(user) && userDatabase[user] == pass) {
	        ...
	        console.log("zhaoyim========redirect", req.cookies.myhost);
	        console.log("zhaoyim======== login headers", req.headers);
	...
	app.get('/auth', function (req, res) {
	    ...
	    console.log("zhaoyim========auth headers", req.headers);
	    console.log("zhaoyim========auth userTokens", userTokens);
	    console.log("zhaoyim========auth userTokens", userTokens['admin'] === 'admin');
